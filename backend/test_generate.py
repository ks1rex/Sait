...
spec = CalculationSpec(
    ...
    intro_text=(
        "Целью данной курсовой работы является проектирование системы "
        "водоснабжения малого посёлка с определением расчётных расходов "
        "воды и гидравлическим расчётом трубопровода.\n\n"
        "В процессе работы определяются среднесуточные, среднечасовые и "
        "максимальные расходы воды, подбирается диаметр трубопровода из "
        "условия обеспечения экономической скорости, а также рассчитывается "
        "требуемый напор насосной станции."
    ),
    references=[
        "СП 31.13330.2021. Водоснабжение. Наружные сети и сооружения. "
        "М.: Минстрой России, 2021.",
        "Абрамов Н.Н. Водоснабжение. — М.: Стройиздат, 1982. — 440 с.",
        "Шевелев Ф.А., Шевелев А.Ф. Таблицы для гидравлического расчёта "
...
spec.conclusion_text = (
    ...
    f"Потери напора на участке длиной {int(spec.input_data[4].value)} м — "
